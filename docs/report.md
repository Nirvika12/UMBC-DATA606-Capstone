...
- **Presentation:** [Power Point Presentation](/docs/606-Capstone-Presentation.pptx)  
...
![Model Comparision](/docs/model_plots/ComparisionTable.png)
...
<img src="/docs/model_plots/TopPredictors.png" alt="Top Predictors of LR" width="600"/>
...
<img src="/docs/model_plots/ROC-Curve.png" alt="ROC-AUC Curve" width="400"/>
...
<img src="/docs/model_plots/ConfusionMatrix.png" alt="Confusion Matrix" width="400"/>

## 6. Application of the Trained Models

To demonstrate the real-world applicability of the trained machine learning model, a **web-based application** was developed that allows users to interact with the predictive system and obtain startup success predictions.

### 6.1 Web Application Overview

The web application enables users to input key characteristics of a student startup—such as team size, mentorship availability, funding status, and founder experience—and receive a **predicted probability of startup success** generated by the trained classification model.

The goal of the application is to translate the predictive model into a practical decision-support tool that can be used by students, mentors, and university entrepreneurship programs.

### 6.2 Technology Choice

**Streamlit** was selected as the primary framework for web application development due to the following advantages:

- Ease of development with minimal setup
- Minimal boilerplate code required
- Native integration with Python-based data science workflows
- Rapid prototyping and deployment capabilities

Streamlit was preferred because it allows faster development while maintaining clarity and usability for non-technical users.

### 6.3 Application Features

The Streamlit application includes the following core features:

- **Interactive input widgets** for entering startup attributes
- **Real-time model inference** using the trained machine learning model
- **Clear and interpretable presentation** of prediction results
- **User-friendly interface** accessible to non-technical users

### 6.4 Practical Significance

This application demonstrates how predictive analytics models can be operationalized into real-world tools. By providing immediate feedback on startup success probability, the application supports informed decision-making and highlights how data-driven insights can enhance entrepreneurship support systems.

![Streamlit](/docs/model_plots/streamlit.png)

## 7. Conclusion

### 7.1 Summary of Work

This project applied data science and machine learning techniques to predict student startup success. Through comprehensive data exploration, feature engineering, model training, evaluation, and deployment, the study identified key factors such as mentorship availability, funding support, and prior founder experience as strong indicators of startup success.

The results demonstrate that predictive analytics can provide meaningful insights into early-stage startup outcomes and support data-driven decision-making in academic entrepreneurship ecosystems.

### 7.2 Potential Applications

The developed model and application can be used in several real-world contexts:

1. **University entrepreneurship programs** to identify and support high-potential student ventures  
2. **Startup incubators and accelerators** for early-stage screening and mentorship allocation  
3. **Student founders** seeking data-driven self-assessment tools to evaluate their startup readiness  

### 7.3 Limitations

Despite promising results, this study has several limitations:

1. The dataset size and scope are limited, which may affect generalizability  
2. Startup success was defined as a binary outcome, potentially oversimplifying real-world success trajectories  
3. The lack of longitudinal data prevents analysis of startup performance over time  

### 7.4 Lessons Learned

Key lessons learned from this project include:

1. Data quality and thoughtful feature selection significantly impact model performance  
2. Model interpretability is essential for building trust among non-technical stakeholders  
3. Deploying models in an application context enhances understanding beyond offline evaluation  

### 7.5 Future Research Directions

Future work can extend this research by:

- Incorporating multi-class or continuous measures of startup success  
- Expanding the dataset to include multiple universities and regions  
- Integrating time-based and longitudinal performance indicators  
- Exploring advanced models such as XGBoost or neural networks for improved predictive performance  
